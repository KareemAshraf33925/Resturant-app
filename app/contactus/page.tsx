...
export default function Contactus() {
  return (
    <>
    <div className="isolate bg-linear-to-r from-white to-orange-300 px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
      ...
      <div className="flex gap-x-4 sm:col-span-2">
        ...
        <label htmlFor="agree-to-policies" className="text-sm/6 text-gray-600">
          ...
          <a href="#" className="font-semibold whitespace-nowrap text-red-700">privacy policy</a>.
        </label>
      </div>
    </div>
    <div className="mt-10">
      <button type="submit" className="cursor-pointer block w-full rounded-md bg-red-700 hover:bg-red-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs  focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Let's talk</button>
    </div>
  </form>
</div>
    </>
